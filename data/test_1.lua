...
--mat1:set_bump(tex1)
mat1:set_specular(tex2, 25)
mat1:set_reflection(0.9)
-- TODO - specular

mat2 = material.new()
mat2:set_diffuse(tex2)
mat2:set_specular(spec1, 25)

mat3 = material.new()
mat3:set_diffuse(diff3)
mat3:set_specular(spec1, 25)

mat4 = material.new()
mat4:set_diffuse(diff4)
mat4:set_specular(spec2, 25)

mat5 = material.new()
mat5:set_diffuse(diff5)
mat5:set_refraction(1.5, false)
...
csg_s2:rotate('x', 90)
csg_s2:rotate('y', 4)
csg_s2:set_material(mat1)

lens = scene.torus("lens", 100, 30)
--scene_root:add_child(lens)
lens:set_material(mat3)
lens:translate({0,0,0})
lens:scale({1,1,1})
--lens:scale({1,0.1,1})
